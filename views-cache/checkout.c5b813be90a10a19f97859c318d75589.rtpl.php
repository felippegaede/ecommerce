											...
											<table class="shop_table">
												...
												<tbody>
													...
													<tr class="cart_item">
														...
														<td class="product-total">
															<span class="amount">RS <?php echo formatPrice($value1["vltotal"]); ?></span>
														</td>
                                                    </tr>
                                                    <?php } ?>
												...
												<tfoot>
													<tr class="cart-subtotal">
														<th>Subtotal</th>
														<td><span class="amount">RS <?php echo formatPrice($cart["vlsubtotal"]); ?></span>
														</td>
													</tr>
													<tr class="shipping">
														<th>Frete</th>
														<td>
															RS <?php echo formatPrice($cart["vlfreight"]); ?>
													...
													<tr class="order-total">
														...
														<td><strong><span class="amount">RS <?php echo formatPrice($cart["vltotal"]); ?></span></strong> </td>
													</tr>
												</tfoot>
											</table>
											<div id="payment">
